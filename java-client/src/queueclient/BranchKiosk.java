 ...
 * @author LOW
 */
public class BranchKiosk extends javax.swing.JFrame {

    /**
     * Creates new form BranchQueue
     */
    public BranchKiosk() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Queue Status:");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("Now Serving:");

        jLabel3.setText("Customer X");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BranchKiosk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BranchKiosk().setVisible(true);
            }
        });
    }
